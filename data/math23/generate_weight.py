...
path_raw = local_path + "/merge_sgns_bigram_char300.txt"
path_vocab = local_path + "/math23k_vocab.json"
path_out_mask = local_path + "/math23_vocab_mask"
path_out_weight = local_path + "/math23_vocab_weight"
